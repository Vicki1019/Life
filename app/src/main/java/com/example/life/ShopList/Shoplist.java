...
public class Shoplist extends Fragment {
    ...
    // POST SHOPPING LIST
    private static String shopurl = "http://192.168.234.110/PHP_API/index.php/Shopping/get_shopping_list";
    RequestQueue shoprequestQueue;
    // POST UPDATE Shopping List
    private static String updatenameurl = "http://192.168.234.110/PHP_API/index.php/Shopping/update_shop_name";
    RequestQueue updatenamerequestQueue;
    private static String updatequantityurl = "http://192.168.234.110/PHP_API/index.php/Shopping/update_shop_quantity";
    RequestQueue updatequantityrequestQueue;
    // POST Delete Shopping List
    private static String deleteurl = "http://192.168.234.110/PHP_API/index.php/Shopping/delete_shop_item";
