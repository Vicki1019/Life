...
public class ChangeRefActivity extends AppCompatActivity {
    ...
    //POST LOCATE NOW
    private static String locatenowurl = "http://172.16.1.57/PHP_API/index.php/Refrigerator/get_member_locate";
    RequestQueue locatenowquestQueue;
    //GET All My Refrigerator
    private static String allrefrefurl = "http://172.16.1.57/PHP_API/index.php/Refrigerator/get_all_locate";
    ...
    private static String changerefurl = "http://172.16.1.57/PHP_API/index.php/Refrigerator/change_ref_locate";
