...
public class ChangeRefActivity extends AppCompatActivity {
    ...
    private static String allrefrefurl = "http://172.16.1.60/PHP_API/index.php/Refrigerator/get_all_locate";
    ...
    private static String changerefurl = "http://172.16.1.60/PHP_API/index.php/Refrigerator/change_ref_locate";
