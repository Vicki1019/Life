...
public class ChangeRefActivity extends AppCompatActivity {
    ...
    private static String allrefrefurl = "http://192.168.65.110/PHP_API/index.php/Refrigerator/get_all_locate";
    ...
    private static String changerefurl = "http://192.168.65.110/PHP_API/index.php/Refrigerator/change_ref_locate";
