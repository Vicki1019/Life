...
public class Reflist extends Fragment {
    ...
    //Get Reflist
    private static String getrefurl = "http://192.168.218.110/PHP_API/index.php/Refrigerator/getreflist";
    RequestQueue getrefrequestQueue;
    // Delete Reflist
    private static String delrefurl = "http://192.168.218.110/PHP_API/index.php/Refrigerator/delete_ref_item";
