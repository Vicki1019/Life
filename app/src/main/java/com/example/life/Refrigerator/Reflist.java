...
public class Reflist extends Fragment {
    ...
    private static String gonestateurl = "http://192.168.170.110/PHP_API/index.php/Refrigerator/update_food_state_gone";
    RequestQueue gonestaterequestQueue;
    //POST ZERO NOTIFY
    private static String zerourl = "http://192.168.170.110/PHP_API/index.php/LineNotify/ZeroNotify";
