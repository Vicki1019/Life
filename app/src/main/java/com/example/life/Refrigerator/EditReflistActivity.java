...
public class EditReflistActivity extends AppCompatActivity {
    ...
    //POST Edit RefList
    private static String editrefurl = "http://172.16.1.53/PHP_API/index.php/Refrigerator/update_ref_item";
    RequestQueue editrefrequestQueue;
    //POST Token
    private static String tokenurl = "http://172.16.1.53/PHP_API/index.php/LineNotify/get_line_token";
    RequestQueue tokenrequestQueue;
    //POST Notify
    private static String notifyurl = "http://172.16.1.53/PHP_API/index.php/LineNotify/SendNotify";
