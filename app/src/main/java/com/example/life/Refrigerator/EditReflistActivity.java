...
public class EditReflistActivity extends AppCompatActivity {
    ...
    //GET Locate
    private static String locateurl = "http://192.168..110/PHP_API/index.php/Refrigerator/getlocate";
    ArrayList<String> locatelist = new ArrayList<>();
    ArrayAdapter<String> locateAdapter;
    RequestQueue locaterequestQueue;
    //Edit RefList
    private static String editrefurl = "http://192.168.99.110/PHP_API/index.php/Refrigerator/update_ref_item";
