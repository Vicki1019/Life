...
public class Grouplist extends Fragment {
    ...
    //POST GroupList
    private static String getgroupurl = "http://192.168.24.110/PHP_API/index.php/Group/get_allGroup_totalMember";
    RequestQueue getgroupquestQueue;
    //POST Create Group
    private static String creategroupurl = "http://192.168.24.110/PHP_API/index.php/Group/create_group";
    RequestQueue creategroupquestQueue;
    //POST JoinGroup
    private static String joingroupurl = "http://192.168.24.110/PHP_API/index.php/Group/join_group";
