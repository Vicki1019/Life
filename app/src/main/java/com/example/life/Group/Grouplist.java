...
public class Grouplist extends Fragment {
    ...
    //POST GroupList
    private static String getgroupurl = "http://172.16.1.75/PHP_API/index.php/Group/get_allGroup_totalMember";
    RequestQueue getgroupquestQueue;
    //POST JoinGroup
    private static String joingroupurl = "http://172.16.1.75/PHP_API/index.php/Group/join_group";
