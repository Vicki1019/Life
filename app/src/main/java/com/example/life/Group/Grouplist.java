...
public class Grouplist extends Fragment {
    ...
    //Get GroupList
    private static String getgroupurl = "http://10.0.53.99/PHP_API/index.php/Group/get_allGroup_totalMember";
    RequestQueue getgroupquestQueue;
    //POST JoinGroup
    private static String joingroupurl = "http://10.0.53.99/PHP_API/index.php/Group/join_group";
