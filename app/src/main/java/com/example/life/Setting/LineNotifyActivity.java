...
public class LineNotifyActivity extends AppCompatActivity {
    ...
    //POST Get&Save Token
    private static String notifyurl = "http://192.168.80.110/PHP_API/index.php/LineNotify/get_line_token";
    RequestQueue notifyrequestQueue;
    //POST Delete Token
    private static String notify_cancel_url = "http://192.168.80.110/PHP_API/index.php/LineNotify/delete_line_token";
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(isChecked == true){
                    if(line_token.equals("null")){
                        Uri notify_uri = Uri.parse("http://192.168.80.110/PHP_API/index.php/LineNotify/LineAuthorize?email="+sEmail);
        ...
        webview.loadUrl("http://192.168.80.110/PHP_API/index.php/LineNotify/LineAuthorize");*/
    }
