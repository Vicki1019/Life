...
public class KindSetActivity extends AppCompatActivity {
    ...
    private static String addurl = "http://140.128.1.58/PHP_API/index.php/UserSetting/addkind";
    RequestQueue addrequestQueue;
    private static String deleteurl = "http://140.128.1.58/PHP_API/index.php/UserSetting/deletekind";
