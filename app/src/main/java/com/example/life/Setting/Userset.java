...
public class Userset extends AppCompatActivity {
   ...
   //Volley
   private static String editnameurl = "http://192.168.2.110/PHP_API/index.php/UserSetting/updatename";
   private static String editpassurl = "http://192.168.2.110/PHP_API/index.php/UserSetting/updatepass";
   //Session
