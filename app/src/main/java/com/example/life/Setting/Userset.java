...
public class Userset extends AppCompatActivity {
   ...
   //Volley
   private static String editnameurl = "http://120.110.81.88/PHP_API/index.php/UserSetting/updatename";
   private static String editpassurl = "http://120.110.81.88/PHP_API/index.php/UserSetting/updatepass";
   //Session
