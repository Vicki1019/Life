...
public class Userset extends AppCompatActivity {
   ...
   //POST Edit User Info
   private static String editnameurl = "http://172.16.1.60/PHP_API/index.php/UserSetting/updateinfo";
   private static String editpassurl = "http://172.16.1.60/PHP_API/index.php/UserSetting/updatepass";
   private static String userurl = "http://172.16.1.60/PHP_API/index.php/UserSetting/getUserInfo";
