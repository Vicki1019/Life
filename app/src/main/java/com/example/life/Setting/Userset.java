...
public class Userset extends AppCompatActivity {
   ...
   //Volley
   private static String editnameurl = "http://172.16.1.47/PHP_API/index.php/UserSetting/updatename";
   private static String editpassurl = "http://172.16.1.47/PHP_API/index.php/UserSetting/updatepass";
   //Session
