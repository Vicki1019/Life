...
public class NotifySetActivity extends AppCompatActivity {
    ...
    private static String notifytimeurl = "http://172.16.1.41/PHP_API/index.php/UserSetting/get_send_hint";
    RequestQueue notifytimerequestQueue;
    // POST Update Notify Time
    private static String updatetimeurl = "http://172.16.1.41/PHP_API/index.php/UserSetting/update_notify_time";
