...
public class NotifySetActivity extends AppCompatActivity {
    ...
    private static String notifytimeurl = "http://192.168.134.110/PHP_API/index.php/UserSetting/get_send_hint";
    RequestQueue notifytimerequestQueue;
    // POST Update Notify Time
    private static String updatetimeurl = "http://192.168.134.110/PHP_API/index.php/UserSetting/update_notify_time";
