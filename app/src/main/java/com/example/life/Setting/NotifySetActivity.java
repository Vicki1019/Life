...
public class NotifySetActivity extends AppCompatActivity {
    ...
    private static String notifytimeurl = "http://140.128.1.58/PHP_API/index.php/UserSetting/get_send_hint";
    RequestQueue notifytimerequestQueue;
    // POST Update Notify Time
    private static String updatetimeurl = "http://140.128.1.58/PHP_API/index.php/UserSetting/update_notify_time";
