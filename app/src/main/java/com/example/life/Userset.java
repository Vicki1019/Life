...
public class Userset extends AppCompatActivity {
   ...
   private static String editnameurl = "http://192.168.128.110/PHP_API/life/updatename.php"; //API URL(updatename.php)


    private static String editpassurl = "http://192.168.128.110/PHP_API/life/updatepass.php"; //API URL(updatepass.php)
