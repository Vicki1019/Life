...
public class Userset extends AppCompatActivity {
   ...
   private static String editnameurl = "http://225.225.225.0/PHP_API/index.php/UserSetting/updateNickname.php"; //API URL(updatename.php)


    private static String editpassurl = "http://225.225.225.0/PHP_API/index.php/UserSetting/updatePass.php"; //API URL(updatepass.php)
